...
struct OnboardingRootView: View {
    ...
    private func finish() {
        ...
        // Close the onboarding window. Menu bar takes over.
...
private struct PermissionsStep: View {
    ...
    var awaitingAccessibilityGrant: Bool {
        permissions.hasMicrophone && !permissions.hasAccessibility
    }
    ...
    var body: some View {
        VStack(spacing: 28) {
            HeaderBlock(
                ...
                subtitle: "Inksper needs your mic to hear you, and Accessibility to paste the result."
            )
            ...
            if awaitingAccessibilityGrant {
                VStack(spacing: 8) {
                    ...
                    .padding(.vertical, 8)
                    .background(Capsule().strokeBorder(.white.opacity(0.7), lineWidth: 1))
                    .foregroundStyle(.white)
        ...
        VStack(spacing: 28) {
            ...
            VStack(spacing: 10) {
                Text("You're ready!")
                    .font(.system(size: 38, weight: .bold, design: .rounded))
                    .foregroundStyle(.white)
                Text("Inksper lives in your menu bar. Hold Fn anytime to dictate.")
                    .font(.title3)
                    .foregroundStyle(.white.opacity(0.9))
                    .multilineTextAlignment(.center)
            }

            PrimaryButton(title: "Start using Inksper", action: finish)
        }
    }
}
